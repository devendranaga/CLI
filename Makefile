...
$(CLI_CLIENT_NAME): $(CLI_CLIENT_OBJ)
	${CLI_CC} -g $(CLI_CLIENT_OBJ) -m32 -o $(CLI_CLIENT_NAME) $(LIBEVCLI_LIB_NAME) $(CLI_LIBS)

$(CLI_SERVICE_NAME): $(CLI_SERVICE_OBJ)
	${CLI_CC} -g $(CLI_SERVICE_OBJ) -m32 -o $(CLI_SERVICE_NAME) $(LIBEVCLI_LIB_NAME) $(LIBNETCLI_LIB_NAME) $(CLI_LIBS)
